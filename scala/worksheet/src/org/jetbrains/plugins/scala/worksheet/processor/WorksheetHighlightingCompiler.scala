...
import org.jetbrains.plugins.scala.externalHighlighters.{CompilerEventGeneratingClient, HighlightingCompiler, ScalaHighlightingMode}
import org.jetbrains.plugins.scala.lang.psi.api.ScalaFile
import org.jetbrains.plugins.scala.util.RescheduledExecutor

import scala.concurrent.duration.DurationInt

final class WorksheetHighlightingCompiler extends HighlightingCompiler {
